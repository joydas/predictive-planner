...
TARGET_COLUMN = "actual_final_budget"
...
def train_final_budget_forecast_model(dataset_path=None) -> dict:
    dataset_path = dataset_path or DATASETS_DIR / "final_budget_forecast_training_dataset.csv"
    df = build_final_budget_forecast_training_dataset(output_path=dataset_path)
